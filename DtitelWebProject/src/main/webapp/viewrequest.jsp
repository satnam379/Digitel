                        ...
                        <table class="table table-bordered">
                            ...
                            <%
						     ...
						     try
						     {
						    	 ...
						    	 String query;
						    	 if(search!=null){
						    	  query = "SELECT * FROM REQUESTUSERS WHERE ID like '%"+search+"%' OR NAME like '%"+search+"%' OR TELENUM like'%"+search+"%' OR CURRENTSTAGE like'%"+search+"%' OR REQUESTEDSTAGE like'%"+search+"%' ";
						    	 }
						    	 else{
						    	   query="SELECT * FROM REQUESTUSERS";
						    	 }
