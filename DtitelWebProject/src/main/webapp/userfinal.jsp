                        ...
                        <table class="table table-bordered">
                            ...
                            <%
						     ...
						     { 
						    	 ...
						    	 String query;
						    	 String data1 = " SELECT TELENUM FROM USERLOGIN WHERE EMAIL='"+Username+"' or TELENUM='"+Username+"'" ;
						    	 rs1 = stmt.executeQuery(data1);
						          ...
						          %>
						              <tr>
						               ...
						               if(rs1.next()) 
						                {
		                                   ...
		                                   <a href="./requestuser.jsp?id=<%=rs.getInt("id")%>" class="btn btn-sm bg-warning text-dark"> <button type="button">change stage</button></a>
						               ...
						               %>
		                                   ...
		                                   <a href="./requestuser.jsp?id=<%=rs.getInt("id")%>" class="btn btn-sm bg-warning text-dark"> <button type="button" disabled>change stage</button></a>
